...
def save_model_weights(epoch_num):
    model_file = path + 'trained_models/duble_human/duble_human_6s' + str(epoch_num).zfill(3)
...
epoch_num = 51
MODEL_PATH = path + 'trained_models/duble_human/duble_human_6s' + str(epoch_num).zfill(3)
load_model_weights(MODEL_PATH)
# In[5]:


if os.path.exists(path + 'trained_models/duble_human/duble_human6s'):
    shutil.rmtree('duble_human6s')
logger = Logger('duble_human6', name='performance_curves')
...
for e in range(epochs):
    ...
    f = open(path + 'trained_models/duble_human/loog.txt', 'a')
