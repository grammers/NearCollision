...
def save_model_weights(epoch_num):
    model_file = path + 'trained_models/alexNet/alexNet_6s' + str(epoch_num).zfill(3)
...
model_path = path + 'trained_models/' + 'alexNet/alexnet.pth'
...
if os.path.exists(path + 'trained_models/alexNet/alexNet6s'):
    shutil.rmtree(path + 'trained_models/alexNet/alexNet6s')
logger = Logger('alexNet6s', name='performance_curves')
...
for e in range(epochs):
    ...
    f = open(path + 'trained_models/alexNet/loog.txt', 'a')
